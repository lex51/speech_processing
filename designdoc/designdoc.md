...
***
Был проведен изначальный анализ данных на датасете [Dusha](https://github.com/salute-developers/golos/tree/master/dusha) в доменах "crowd" и "podcast". В процессе анализа были построены гистограммы, показывающие распределение звуковых файлов по различным эмоциям. Также была проведена проверка на наличие пропущенных значений, дубликатов и противоречивой информации. В результате была получена
информация о качестве и точности данных в датасете.
